      ...
      <div className="banner-intro position-relative">
        ...
        <div className="container">
          <div className="text-wrapper pb-60 position-relative">
            <h1
              className="hero-heading font-recoleta fw-light mb-30 lg-mb-50 pe-xxl-4" style={{fontSize:"80px", textAlign:"center"}}
              data-aos="fade-up"
            >
              <span className="line-one">Try,</span> KAISPE employee leave management app 
              <span className="line-two">and </span> &amp; reduce paperwork.
            </h1>
